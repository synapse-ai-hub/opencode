    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          "meta-agent": {
            name: "meta-agent",
            description: "WhatsApp API Integration Specialist - Consulta notebooks de WhatsApp API",
            mode: "primary",
            color: "#F97316",
            temperature: 0.3,
            topP: 0.85,
            prompt: PROMPT_META_AGENT,
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              task: { "*": "deny", "software-engineer": "allow", "spec-miner": "allow",
                ...
                "product-manager": "allow", "ai-architect": "allow",
                 "ml-engineer": "allow" },
              skill: { "*": "deny", "code-documenter": "allow", "docs-template": "allow"},
            }), user),
            options: {},
          },
          ask: {
          ...
          builder: {
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              task: { "*": "deny", "ai-architect": "allow", "code-reviewer": "allow",
                 "qa": "allow", "ai-research": "allow",  "software-engineer": "allow",
                 "ml-engineer": "allow", "meta-agent": "allow", "security-specialist": "allow", "spec-miner": "allow",
                 "update": "allow", "agent-engineer": "allow", "workspace-explorer": "allow" },
               skill: { "*": "deny",  "docs-template": "allow",  "api-designer": "allow", 
                 "code-documenter": "allow", "debugging-wizard": "allow",
                 "fastapi-expert": "allow", 
                 "javascript-pro": "allow",
                "mcp-developer": "allow", "pandas-pro": "allow",
                "python-pro": "allow", "react-expert": "allow",
                "sql-pro": "allow", "typescript-pro": "allow",
                "fullstack-guardian": "allow",
          ...
          "code-reviewer": {
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              task: { "*": "deny", "ai-architect": "allow", "ai-research": "allow",
                "product-manager": "allow", "qa": "allow", 
                "security-specialist": "allow", "spec-miner": "allow",
                 "software-engineer": "allow", "update": "allow",
                 "agent-engineer": "allow", "meta-agent": "allow" },
          ...
          "data-analyst": {
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              apply_patch: "deny", todowrite: "deny", webfetch: "allow", websearch: "allow",
              question: "allow",
              task: { "*": "deny", "ai-research": "allow", 
                "update": "allow" },
              skill: { "*": "deny",  "docs-template": "allow",  "pandas-pro": "allow",
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              task: { "*": "deny", "planner": "allow", "builder": "allow",
                ...
                "product-manager": "allow", "product-owner": "allow", "spec-miner": "allow",
                 "ml-engineer": "allow", "workspace-explorer": "allow",
                 "update": "allow", "agent-engineer": "allow", "llm-auditor": "allow",
                 "meta-agent": "allow" },
               skill: { "*": "deny",
                "code-documenter": "allow",
                "docs-template": "allow", "dispatching-parallel-agents": "allow" },
            }), user),
            options: {},
          },
          "workspace-explorer": {
          ...
          "llm-auditor": {
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              question: "allow",
               "notebooklm_ask_question": "allow",
              task: { "*": "deny", "ai-architect": "allow", "ai-research": "allow",
                  "update": "allow", "agent-engineer": "allow", "ml-engineer": "allow" },
               skill: { "*": "deny",  "docs-template": "allow",  "llm-review": "allow",
          ...
          "ml-engineer": {
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              task: { "*": "deny", "ai-architect": "allow", "ai-research": "allow",
                ...
                "product-manager": "allow",  "update": "allow",
                "workspace-explorer": "allow", "agent-engineer": "allow",
                "software-engineer": "allow" },
              skill: { "*": "deny",  "docs-template": "allow", "fastapi-expert": "allow",
                "fine-tuning-expert": "allow", "code-documenter": "allow",
          ...
          "product-manager": {
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              question: "allow",
              task: { "*": "deny", "ai-architect": "allow", "ai-research": "allow",
                "product-owner": "allow",  "proposal-generator": "allow",
                "update": "allow", "spec-miner": "allow",
                "workspace-explorer": "allow", "agent-engineer": "allow" },
              skill: { "*": "deny",  "docs-template": "allow",  "feature-forge": "allow",
          ...
          "proposal-generator": {
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              question: "allow",
              "notebooklm_ask_question": "allow",
              task: { "*": "deny", "update": "allow", },
              skill: { "*": "deny", "proposal-framework": "allow",
                "docs-template": "allow" },
            }), user),
            options: {},
          },
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              task: { "*": "deny", "ai-architect": "allow", "ai-research": "allow",
                ...
                "product-manager": "allow", 
                 ...
                 "agent-engineer": "allow", "meta-agent": "allow" },
               skill: { "*": "deny",  "code-documenter": "allow", "docs-template": "allow",  "debugging-wizard": "allow", 
                "secure-code-guardian": "allow", "security-reviewer": "allow",
                "test-master": "allow", "qa-expert": "allow",
                "evaluation-specialist": "allow" },
            }), user),
            options: {},
          },
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              question: "allow",
               task: { "*": "deny", "ai-architect": "allow", "code-reviewer": "allow",
                 ...
                 "spec-miner": "allow", "update": "allow",
                 "agent-engineer": "allow", "meta-agent": "allow" },
               skill: { "*": "deny",  "docs-template": "allow", "secure-code-guardian": "allow", "security-reviewer": "allow",
                  },
            }), user),
            options: {},
          },
          "software-engineer": {
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              apply_patch: "deny", todowrite: "deny", webfetch: "allow", websearch: "allow",
              question: "allow",
              task: { "*": "deny", "code-documenter": "allow", "ai-architect": "allow", "code-reviewer": "allow",
                "security-specialist": "allow", "spec-miner": "allow",
                "product-manager": "allow", "ai-research": "allow",
                 "update": "allow",
                "workspace-explorer": "allow", "ml-engineer": "allow",
                "agent-engineer": "allow" },
              skill: { "*": "deny",  "docs-template": "allow",  "debugging-wizard": "allow", "devops-engineer": "allow",
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
              ...
              question: "allow",
               task: { "*": "deny", "ai-research": "allow", "ai-architect": "allow",
                 ...
                 "workspace-explorer": "allow", "agent-engineer": "allow",
                 "meta-agent": "allow" },
              skill: { "*": "deny",  "docs-template": "allow",  "spec-miner": "allow", "code-documenter": "allow",
                "api-designer": "allow" },
            }), user),
            options: {},
          },
