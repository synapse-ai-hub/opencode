...
// Generated from frontmatter in agent/prompt/*.txt
// ═══════════════════════════════════════════════════════
...
import { ProviderTransform as PT } from "@/provider/transform"
...
// ── Built-in agent prompts that stay ─────────────────
      ...
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          "agent-engineer": {
            ...
            permission: Permission.merge(defaults, Permission.fromConfig({
                            ...
                            skill: {
                              ...
                              "debugging-wizard": "allow",
                              "python-pro": "allow",
                              "context-engineer": "allow",
                              "guardrail-implementer": "allow",
          ...
          "workspace-explorer": {
            ...
            temperature: 0.2,
            topP: 0.75,
            prompt: PROMPT_WORKSPACE_EXPLORER,
            permission: Permission.merge(defaults, Permission.fromConfig({
                            log_query: "allow",
                            read: "allow",
                            edit: "allow",
          ...
          "proposal-generator": {
            ...
            description: "Proposal Generator - Assembles formal implementation proposals (quotes) for specific B2B clients",
            mode: "subagent",
            color: "#10B981",
